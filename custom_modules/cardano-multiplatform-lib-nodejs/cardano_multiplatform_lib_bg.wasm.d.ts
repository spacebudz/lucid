...
export function transactionbuilderconfigbuilder_prefer_split_change(a: number, b: number, c: number, d: number, e: number): number;
...
export function transactionbuilder_add_script_input(a: number, b: number, c: number, d: number, e: number): void;
export function transactionbuilder_add_bootstrap_input(a: number, b: number, c: number, d: number): void;
export function transactionbuilder_add_input(a: number, b: number, c: number, d: number, e: number): void;
...
export function transactionbuilder_construct(a: number): number;
...
export function data_new(a: number, b: number): number;
export function data_get(a: number): number;
export function __wbg_script_free(a: number): void;
export function script_new_native(a: number, b: number): number;
export function script_new_plutus_v1(a: number, b: number): number;
export function script_new_plutus_v2(a: number, b: number): number;
...
export function scriptref_new(a: number, b: number): number;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h21da04d4be89156a(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__hf20c15ebccf7f833(a: number, b: number, c: number, d: number): void;
