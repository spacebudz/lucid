...
class TransactionWitnessSetBuilder {
  ...
  /**
   * @param {boolean | undefined} encoding
   * @returns {TransactionWitnessSet}
   */
  build(encoding) {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.transactionwitnesssetbuilder_build(
        retptr,
        this.ptr,
        isLikeNone(encoding) ? 0xFFFFFF : encoding ? 1 : 0,
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      var r2 = getInt32Memory0()[retptr / 4 + 2];
...
module.exports.__wbindgen_closure_wrapper7024 = function (arg0, arg1, arg2) {
