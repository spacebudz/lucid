...
export function transactioninputs_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactioninputs_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionoutputs_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionoutputs_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionbody_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionbody_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactioninput_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactioninput_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionoutput_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionoutput_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function stakeregistration_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
export function stakeregistration_to_js_value(a: number, b: number): void;
export function stakeregistration_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function stakederegistration_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function stakederegistration_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function stakedelegation_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function stakedelegation_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function ed25519keyhashes_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function ed25519keyhashes_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function poolregistration_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function poolregistration_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function poolretirement_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function genesiskeydelegation_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function genesiskeydelegation_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function moveinstantaneousrewardscert_to_js_value(
  a: number,
  b: number,
): void;
...
export function mirtostakecredentials_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function mirtostakecredentials_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function moveinstantaneousreward_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function dnsrecordaoraaaa_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function singlehostaddr_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function singlehostname_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function stakecredentials_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function stakecredentials_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function rewardaddresses_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function rewardaddresses_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionwitnessset_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionwitnessset_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function timelockexpiry_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function proposedprotocolparameterupdates_to_js_value(
  a: number,
  b: number,
): void;
...
export function protocolversion_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function protocolversion_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function protocolparamupdate_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function protocolparamupdate_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionbodies_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionbodies_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionwitnesssets_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionwitnesssets_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionindexes_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function operationalcert_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function operationalcert_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function bip32privatekey_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
export function bip32privatekey_as_bytes(a: number, b: number): void;
export function bip32privatekey_from_bech32(
  a: number,
  b: number,
  c: number,
): void;
...
export function bip32publickey_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
export function bip32publickey_as_bytes(a: number, b: number): void;
export function bip32publickey_from_bech32(
  a: number,
  b: number,
  c: number,
): void;
...
export function privatekey_from_extended_bytes(
  a: number,
  b: number,
  c: number,
): void;
export function privatekey_from_normal_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function bootstrapwitness_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function bootstrapwitness_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function ed25519signature_from_bech32(
  a: number,
  b: number,
  c: number,
): void;
export function ed25519signature_from_hex(
  a: number,
  b: number,
  c: number,
): void;
export function ed25519signature_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function ed25519keyhash_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function ed25519keyhash_from_bech32(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionhash_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
export function transactionhash_from_bech32(
  a: number,
  b: number,
  c: number,
): void;
export function transactionhash_from_hex(a: number, b: number, c: number): void;
export function genesisdelegatehash_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
export function genesisdelegatehash_from_bech32(
  a: number,
  b: number,
  c: number,
): void;
export function genesisdelegatehash_from_hex(
  a: number,
  b: number,
  c: number,
): void;
...
export function auxiliarydatahash_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function auxiliarydatahash_from_bech32(
  a: number,
  b: number,
  c: number,
): void;
export function auxiliarydatahash_to_hex(a: number, b: number): void;
export function auxiliarydatahash_from_hex(
  a: number,
  b: number,
  c: number,
): void;
export function poolmetadatahash_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
export function poolmetadatahash_from_bech32(
  a: number,
  b: number,
  c: number,
): void;
export function poolmetadatahash_from_hex(
  a: number,
  b: number,
  c: number,
): void;
...
export function scriptdatahash_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
export function scriptdatahash_from_bech32(
  a: number,
  b: number,
  c: number,
): void;
...
export function metadatamap_get_str(
  a: number,
  b: number,
  c: number,
  d: number,
...
export function transactionmetadatum_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionmetadatum_new_bytes(
  a: number,
  b: number,
  c: number,
): void;
export function transactionmetadatum_new_text(
  a: number,
  b: number,
  c: number,
): void;
...
export function generaltransactionmetadata_to_js_value(
  a: number,
  b: number,
): void;
...
export function stakecredential_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function stakecredential_from_json(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionbuilderconfigbuilder_build(
  a: number,
  b: number,
): void;
...
export function transactionbuilder_add_output(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionbuilder_fee_for_output(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionbuilder_add_collateral(
  a: number,
  b: number,
  c: number,
): void;
...
export function transactionbuilder_get_explicit_input(
  a: number,
  b: number,
): void;
export function transactionbuilder_get_implicit_input(
  a: number,
  b: number,
): void;
...
export function transactionbuilder_get_explicit_output(
  a: number,
  b: number,
): void;
...
export function transactionwitnesssetbuilder_build(a: number, b: number): void;
...
export function scriptwitness_to_js_value(a: number, b: number): void;
export function scriptwitness_from_json(a: number, b: number, c: number): void;
...
export function constrplutusdata_from_bytes(
  a: number,
  b: number,
  c: number,
): void;
...
export function data_from_bytes(a: number, b: number, c: number): void;
export function data_to_json(a: number, b: number): void;
export function data_to_js_value(a: number, b: number): void;
export function data_from_json(a: number, b: number, c: number): void;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h8b6cac31a9c50230(
  a: number,
  b: number,
  c: number,
): void;
...
export function wasm_bindgen__convert__closures__invoke2_mut__h271eb41e68580694(
  a: number,
  b: number,
  c: number,
  d: number,
