...
export interface InitOutput {
  ...
  readonly moveinstantaneousrewardscert_from_json: (a: number, b: number) => number;
  ...
  readonly proposedprotocolparameterupdates_from_json: (a: number, b: number) => number;
  ...
  readonly generaltransactionmetadata_from_json: (a: number, b: number) => number;
  ...
  readonly transactionbuilder_add_inputs_from: (a: number, b: number) => void;
  ...
  readonly transactionbuilder_balance: (a: number, b: number, c: number) => void;
  ...
  readonly vrfvkey_from_hex: (a: number, b: number) => number;
