...
export function vrfvkey_to_bech32(
  a: number,
  b: number,
  c: number,
  d: number,
...
export function vrfvkey_from_hex(a: number, b: number): number;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__haaf4f94fe6f806b8(
  a: number,
  b: number,
  c: number,
): void;
...
export function wasm_bindgen__convert__closures__invoke2_mut__h7a735230209646c7(
  a: number,
  b: number,
  c: number,
  d: number,
