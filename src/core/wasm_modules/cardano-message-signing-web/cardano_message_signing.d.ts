...
export interface InitOutput {
  ...
  readonly cosesign1_signed_data: (a: number, b: number, c: number, d: number, e: number) => number;
  ...
  readonly signedmessage_from_user_facing_encoding: (a: number, b: number) => number;
