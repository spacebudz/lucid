...
export const taggedcbor_to_bytes: (a: number) => [number, number];
export const taggedcbor_from_bytes: (a: number, b: number) => [number, number, number];
...
export const cborarray_to_bytes: (a: number) => [number, number];
export const cborarray_from_bytes: (a: number, b: number) => [number, number, number];
...
export const cborobject_to_bytes: (a: number) => [number, number];
export const cborobject_from_bytes: (a: number, b: number) => [number, number, number];
...
export const cborspecial_to_bytes: (a: number) => [number, number];
export const cborspecial_from_bytes: (a: number, b: number) => [number, number, number];
...
export const cborspecial_as_float: (a: number) => [number, number];
export const cborspecial_as_unassigned: (a: number) => number;
export const __wbg_cborvalue_free: (a: number, b: number) => void;
export const cborvalue_to_bytes: (a: number) => [number, number];
export const cborvalue_from_bytes: (a: number, b: number) => [number, number, number];
...
export const cborvalue_as_bytes: (a: number) => [number, number];
export const cborvalue_as_text: (a: number) => [number, number];
...
export const bignum_to_bytes: (a: number) => [number, number];
export const bignum_from_bytes: (a: number, b: number) => [number, number, number];
export const bignum_from_str: (a: number, b: number) => [number, number, number];
export const bignum_to_str: (a: number) => [number, number];
export const bignum_checked_mul: (a: number, b: number) => [number, number, number];
export const bignum_checked_add: (a: number, b: number) => [number, number, number];
export const bignum_checked_sub: (a: number, b: number) => [number, number, number];
...
export const protectedheadermap_to_bytes: (a: number) => [number, number];
export const protectedheadermap_from_bytes: (a: number, b: number) => [number, number, number];
...
export const label_to_bytes: (a: number) => [number, number];
export const label_from_bytes: (a: number, b: number) => [number, number, number];
...
export const label_as_text: (a: number) => [number, number];
...
export const labels_to_bytes: (a: number) => [number, number];
export const labels_from_bytes: (a: number, b: number) => [number, number, number];
...
export const cosesignatures_to_bytes: (a: number) => [number, number];
export const cosesignatures_from_bytes: (a: number, b: number) => [number, number, number];
...
export const countersignature_to_bytes: (a: number) => [number, number];
export const countersignature_from_bytes: (a: number, b: number) => [number, number, number];
...
export const headermap_to_bytes: (a: number) => [number, number];
export const headermap_from_bytes: (a: number, b: number) => [number, number, number];
...
export const headermap_key_id: (a: number) => [number, number];
export const headermap_set_init_vector: (a: number, b: number, c: number) => void;
export const headermap_init_vector: (a: number) => [number, number];
export const headermap_set_partial_init_vector: (a: number, b: number, c: number) => void;
export const headermap_partial_init_vector: (a: number) => [number, number];
...
export const headermap_set_header: (a: number, b: number, c: number) => [number, number];
...
export const headers_to_bytes: (a: number) => [number, number];
export const headers_from_bytes: (a: number, b: number) => [number, number, number];
...
export const cosesignature_to_bytes: (a: number) => [number, number];
export const cosesignature_from_bytes: (a: number, b: number) => [number, number, number];
export const cosesignature_headers: (a: number) => number;
export const cosesignature_signature: (a: number) => [number, number];
export const cosesignature_new: (a: number, b: number, c: number) => number;
export const __wbg_cosesign1_free: (a: number, b: number) => void;
export const cosesign1_to_bytes: (a: number) => [number, number];
export const cosesign1_from_bytes: (a: number, b: number) => [number, number, number];
export const cosesign1_headers: (a: number) => number;
export const cosesign1_payload: (a: number) => [number, number];
export const cosesign1_signature: (a: number) => [number, number];
export const cosesign1_signed_data: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
...
export const cosesign_to_bytes: (a: number) => [number, number];
export const cosesign_from_bytes: (a: number, b: number) => [number, number, number];
export const cosesign_headers: (a: number) => number;
export const cosesign_payload: (a: number) => [number, number];
...
export const signedmessage_to_bytes: (a: number) => [number, number];
export const signedmessage_from_bytes: (a: number, b: number) => [number, number, number];
export const signedmessage_new_cose_sign: (a: number) => number;
export const signedmessage_new_cose_sign1: (a: number) => number;
export const signedmessage_from_user_facing_encoding: (a: number, b: number) => [number, number, number];
export const signedmessage_to_user_facing_encoding: (a: number) => [number, number];
...
export const sigstructure_to_bytes: (a: number) => [number, number];
export const sigstructure_from_bytes: (a: number, b: number) => [number, number, number];
...
export const sigstructure_external_aad: (a: number) => [number, number];
export const sigstructure_payload: (a: number) => [number, number];
...
export const coseencrypt0_to_bytes: (a: number) => [number, number];
export const coseencrypt0_from_bytes: (a: number, b: number) => [number, number, number];
export const coseencrypt0_headers: (a: number) => number;
export const coseencrypt0_ciphertext: (a: number) => [number, number];
export const coseencrypt0_new: (a: number, b: number, c: number) => number;
export const passwordencryption_to_bytes: (a: number) => [number, number];
export const passwordencryption_from_bytes: (a: number, b: number) => [number, number, number];
export const passwordencryption_new: (a: number) => number;
export const __wbg_coserecipients_free: (a: number, b: number) => void;
export const coserecipients_to_bytes: (a: number) => [number, number];
export const coserecipients_from_bytes: (a: number, b: number) => [number, number, number];
...
export const coseencrypt_to_bytes: (a: number) => [number, number];
export const coseencrypt_from_bytes: (a: number, b: number) => [number, number, number];
export const coseencrypt_headers: (a: number) => number;
export const coseencrypt_ciphertext: (a: number) => [number, number];
...
export const coserecipient_to_bytes: (a: number) => [number, number];
export const coserecipient_from_bytes: (a: number, b: number) => [number, number, number];
export const pubkeyencryption_to_bytes: (a: number) => [number, number];
export const pubkeyencryption_from_bytes: (a: number, b: number) => [number, number, number];
export const pubkeyencryption_new: (a: number) => number;
export const __wbg_cosekey_free: (a: number, b: number) => void;
export const cosekey_to_bytes: (a: number) => [number, number];
export const cosekey_from_bytes: (a: number, b: number) => [number, number, number];
...
export const cosekey_key_id: (a: number) => [number, number];
...
export const cosekey_base_init_vector: (a: number) => [number, number];
export const cosekey_header: (a: number, b: number) => number;
export const cosekey_set_header: (a: number, b: number, c: number) => [number, number];
...
export const coserecipient_ciphertext: (a: number) => [number, number];
