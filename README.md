...
```js
import { Lucid } from "https://deno.land/x/lucid@0.6.3/mod.ts";
```
...
```html
<script type="module">
import { Lucid } from "https://unpkg.com/lucid-cardano@0.6.3/web/mod.js"
// ...
</script>
```
...
```js
// import { Blockfrost, Lucid } from "https://deno.land/x/lucid@0.6.3/mod.ts"; Deno
...
Commit hash: **2b4c28892746ff3c424db4041a8aa44f0f8a9e57**
