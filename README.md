...
```js
import { Lucid } from "https://deno.land/x/lucid@0.7.4/mod.ts";
```
...
```html
<script type="module">
import { Lucid } from "https://unpkg.com/lucid-cardano@0.7.4/web/mod.js"
// ...
</script>
```
...
```js
// import { Blockfrost, Lucid } from "https://deno.land/x/lucid@0.7.4/mod.ts"; Deno
