...
```js
import { Lucid } from "https://deno.land/x/lucid@0.10.2/mod.ts";
```
...
```html
<script type="module">
import { Lucid } from "https://unpkg.com/lucid-cardano@0.10.2/web/mod.js"
// ...
</script>
```
...
```js
// import { Blockfrost, Lucid } from "https://deno.land/x/lucid@0.10.2/mod.ts"; Deno
