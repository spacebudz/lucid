...
```js
import { Lucid } from "https://deno.land/x/lucid@0.9.9/mod.ts";
```
...
```html
<script type="module">
import { Lucid } from "https://unpkg.com/lucid-cardano@0.9.9/web/mod.js"
// ...
</script>
```
...
```js
// import { Blockfrost, Lucid } from "https://deno.land/x/lucid@0.9.9/mod.ts"; Deno
