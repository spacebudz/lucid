...
```js
import { Lucid } from "https://deno.land/x/lucid@0.7.3/mod.ts";
```
...
```html
<script type="module">
import { Lucid } from "https://unpkg.com/lucid-cardano@0.7.3/web/mod.js"
// ...
</script>
```
...
```js
// import { Blockfrost, Lucid } from "https://deno.land/x/lucid@0.7.3/mod.ts"; Deno
...
Commit hash: **fd08a29da5cc27ef40e15ce1c27bc4fdb27ee294**
